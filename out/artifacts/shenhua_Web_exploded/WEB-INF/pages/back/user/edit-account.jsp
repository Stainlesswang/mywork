		...
		<tbody>
			...
			<tr class="text-c">
				<td colspan="4">
					...
					<input type="hidden" name="is_super" id="is_super" value=""/>
...
<script type="text/javascript" src="<%=path %>/js/custome/user/edit-account.js"></script>
