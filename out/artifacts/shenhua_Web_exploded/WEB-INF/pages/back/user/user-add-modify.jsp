	...
	<table class="table  table-bg" id="datatable">
		<tbody>
			...
			<tr class="text-l">
				...
				<td class="td-width-text">
				<input type="text" class="input-text mydisable" readonly="readonly" value="${data.selectOrgName }"  style="width:80%;" id="org_name"  name="org_name">
					<input type="hidden" id="org_id" name="org_id" value="${data.selectOrgId }"/>
			...
			<tr class="text-l">
				<td class="text-r td-width">性别:</td>
					<td>
						<div class="radio-box">
							<input type="radio" id="sex-1" name="_sex" value="0" checked style="margin:0;">
							<label for="sex-1" style="font-weight: normal;">男</label>
						</div>
						<div class="radio-box">
							<input type="radio" id="sex-2" name="_sex" value="1" style="margin:0;">
							<label for="sex-2" style="font-weight: normal;">女</label>
						</div>
					</td>
			...
			<tr class="text-l">
				...
				<td >
					<div class="radio-box">
						...
						<label for="isAdminY" style="font-weight: normal;">是</label>
					</div>
					<div class="radio-box">
						<input type="radio" id="isAdminN" name="_admin_type" checked value="0" style="margin:0;">
				...
				<td class="td-width-text">
					<div class="radio-box">
						...
						<label for="isTempY" style="font-weight: normal;">是</label>
					</div>
					<div class="radio-box">
						<input type="radio" id="isTempN" name="is_temp" checked value="0" style="margin:0;">
						<label for="isTempN" style="font-weight: normal;">否</label>
					</div>
				</td>
			</tr>
			<!-- <tr class="text-l">
