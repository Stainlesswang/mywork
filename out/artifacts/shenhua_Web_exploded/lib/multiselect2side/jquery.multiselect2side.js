		...
		return this.each(function () {
			...
			var divUpDown =
					"<div class='ms2side__updown'>" +"<br>"+
						"<p class='SelSort btn btn p-primary' title='排序'>" + o.labelSort + "</p>" +
						"<p class='MoveTop btn p-primary' title='选定选项移动到顶部'>" + o.labelTop + "</p>" +
						"<p class='MoveUp btn p-primary' title='向上移动选定的选项'>" + o.labelUp + "</p>" +
						"<p class='MoveDown btn p-primary' title='向下移动选定的选项'>" + o.labelDown + "</p>" +
						"<p class='MoveBottom btn p-primary' title='选定选项移动到底部'>" + o.labelBottom + "</p>" +
					"</div>";
			...
			var htmlToAdd = 
				"<div class='ms2side__div'>" +
					...
					"<div class='ms2side__options'>" +
						...
						?
						("<br><div class='AddOne btn primary' title='添加所选'>&rsaquo;</div><br>" +
						"<div class='AddAll btn primary' title='全部添加'>&raquo;</div><br>" +
						"<div class='RemoveOne btn primary' title='删除选定'>&lsaquo;</div><br>" +
						"<div class='RemoveAll btn primary' title='全部删除'>&laquo;</div><br>")
						:
						("<div class='AddOne btn primary' title='添加所选'>&lsaquo;</div><br>" +
						"<div class='AddAll btn primary' title='全部添加'>&laquo;</div><br>" +
						"<div class='RemoveOne btn primary' title='删除选定'>&rsaquo;</div><br>" +
						"<div class='RemoveAll btn primary' title='全部删除'>&raquo;</div><br>")
						) +
					"</div>" +
					"<div class='ms2side__select'>" +
