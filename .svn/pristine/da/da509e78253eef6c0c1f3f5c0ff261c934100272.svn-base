...
public class WeixinUtils {
	...
	public static Map<String,Long> accessTokenTimeMapping = new HashMap<String,Long>();
	public static Map<String,String> accessTokenMapping = new HashMap<String,String>();
	/**
	 * 获取AccessToken。
	 * @param appId
	 * @param appSecret
	...
	public static String getAccessToken(String appId, String appSecret) { // 获得ACCESS_TOKEN
		...
		if(false)return "h0cM_D_jkz3VfYY6hx6ywQFvF18Gum_T0izDbZWY4bihsKuDXN92ylswg2vElkGC_BbwSgbC_23rvke7wTyWKe1nmhmRFCk7jWuR5SRw9PdBjgjJmMqehNPXa783EushNGJgAEAJCF";
	 ...
	 * @throws IOException
	 */
	public static String resetMenu(String appId, String appSecret, String menu,String access_token) throws IOException {
		//[{
	 ...
	 * @return
	 */
	public static JSONObject getFollowers(String appId, String appSecret,String access_token){
		return getFollowers(appId,appSecret,null,access_token);
	}
	/**
	 * 获取粉丝列表。
	 * @param appId
	 ...
	 * @return
	 */
	public static JSONObject getFollowers(String appId, String appSecret, String nextOpenId,String access_token){
		if(access_token==null||"".equals(access_token))
		{
			access_token = getAccessToken(appId, appSecret);
		}
	 ...
	 * @return
	 */
	public static JSONObject getFollowerInfo(String appId, String appSecret, String openId,String access_token){
		if(access_token==null||"".equals(access_token))
		{
			access_token = getAccessToken(appId, appSecret);
		}
	 ...
	 * @return
	 * @creater: 李梦婷
	 * @creationDate:2016年11月7日 下午1:58:00
	 */
	public static JSONObject batchGetFollowerInfo(String appId, String appSecret, List<String> userList,String access_token)
	{
		if(access_token==null||"".equals(access_token))
		{
			access_token = getAccessToken(appId, appSecret);
		...
		try {
			List<Map<String,String>> userListTemp=new ArrayList<Map<String,String>>();
			for (String openId: userList) {
				Map<String,String> map=new HashMap<String,String>();
				map.put("openid", openId);
				map.put("lang", "zh-CN");
				userListTemp.add(map);
			}
			j.put("user_list", userListTemp);
		...
		System.out.println("WeixinManager.batchGetFollowerInfo()"+rtn);
		JSONObject json;
		try {
			json = new JSONObject(rtn);
		} catch (JSONException e) {
	 ...
	 */
	public static JSONObject createGroup(String appId, String appSecret, String groupName,String accessToken){
	 ...
	 * @return
	 */
	public static JSONObject getAllGroups(String appId, String appSecret,String access_token){
		if(access_token==null||"".equals(access_token))
		{
			access_token = getAccessToken(appId, appSecret);
		}
	 ...
	 */
	public static JSONObject getUserGroup(String appId, String appSecret, String openId,String access_token){
		if(access_token==null||"".equals(access_token))
		{
			access_token = getAccessToken(appId, appSecret);
		}
	 ...
	 * @return
	 * @creater: 李梦婷
	 * @creationDate:2016年11月25日 下午5:45:53
	 */
	public static JSONObject getTemplateList(String appId, String appSecret, String access_token){
		if(access_token==null||"".equals(access_token))
		{
			access_token = getAccessToken(appId, appSecret);
		}
		...
		System.out.println("WeixinManager.getTemplateList()"+rtn);
		JSONObject json;
		try {
			json = new JSONObject(rtn);
		} catch (JSONException e) {
	 ...
	 * @return
	 * @creater: 李梦婷
	 * @creationDate:2016年11月25日 下午6:14:13
	 */
	public static JSONObject setIndustry(String appId, String appSecret, String[] industryIds,String access_token){
		if(access_token==null||"".equals(access_token))
		{
			access_token = getAccessToken(appId, appSecret);
		}
		...
		JSONObject j = new JSONObject();
		try {
			String name="industry_id";
			for (int i = 0; i < industryIds.length; i++) {
				j.put(name+(i+1), industryIds[i]);
			}
		} catch (JSONException e1) {
			e1.printStackTrace();
		}
		System.out.println(j.toString());
		String rtn = weixinRequest(url, j.toString(), "POST");
		System.out.println("WeixinManager.setIndustry()"+rtn);
		JSONObject json;
		try {
			json = new JSONObject(rtn);
		} catch (JSONException e) {
	 ...
	 * @return
	 * @creater: 李梦婷
	 * @creationDate:2016年11月25日 下午6:21:20
	 */
	public static JSONObject getIndustry(String appId, String appSecret,String access_token){
		if(access_token==null||"".equals(access_token))
		{
			access_token = getAccessToken(appId, appSecret);
		}
		...
		String rtn = weixinRequest(url, null, "GET");
		System.out.println("WeixinManager.getIndustry()"+rtn);
		JSONObject json;
		try {
			json = new JSONObject(rtn);
		} catch (JSONException e) {
	 ...
	 * @return
	 * @creater: 李梦婷
	 * @creationDate:2016年11月26日 下午3:24:47
	 */
	public static JSONObject addTemplate(String appId, String appSecret,JSONObject templateObj,String access_token){
		if(access_token==null||"".equals(access_token))
		{
			access_token = getAccessToken(appId, appSecret);
		}
...
//		}
		...
		String rtn = weixinRequest(url, templateObj.toString(), "POST");
		System.out.println("WeixinManager.addTemplate()"+rtn);
		JSONObject json;
		try {
			json = new JSONObject(rtn);
		} catch (JSONException e) {
 ...
 */
	 ...
	 */
	public static JSONObject updateGroup(String appId, String appSecret, String groupId, String newGroupName,String access_token){
		if(access_token==null||"".equals(access_token))
		{
			access_token = getAccessToken(appId, appSecret);
		}
	 ...
	 * @return 如 {"errcode": 0, "errmsg": "ok"}
	 */
	public static JSONObject updateUserGroup(String appId, String appSecret, String toGroupId, String openId,String access_token){
		if(access_token==null||"".equals(access_token))
		{
			access_token = getAccessToken(appId, appSecret);
		}
		...
		String rtn = weixinRequest(url, j.toString(), "POST");
		System.out.println("WeixinManager.updateUserGroup()"+rtn);
		JSONObject json;
		try {
			json = new JSONObject(rtn);
		} catch (JSONException e) {
	 ...
	 * @throws IOException
	 */
	public static JSONObject uploadMedia(String appId, String appSecret, String type
			, String filePath,String access_token) throws IOException{
		if(access_token==null||"".equals(access_token))
		{
			access_token = getAccessToken(appId, appSecret);
		}
...
//    	shc.upload(url, m);
	 ...
	 * @return
	 */
	public static JSONObject uploadnews(String appId, String appSecret, List<Map<String, String>> infoMapList,String access_token){
		if(access_token==null||"".equals(access_token))
		{
			access_token = getAccessToken(appId, appSecret);
		}
		...
		for(Map<String, String> infoMap : infoMapList){
			...
			try {
				String thumb_media_id = uploadMedia(appId, appSecret, "thumb", filePath,access_token).getString("thumb_media_id");
...
//	}
	 ...
	 */
	public static JSONObject sendGroupMsg(String appId, String appSecret,String msgType, String mediaId, 
			String groupId,String access_token,boolean is_to_all){
		if(access_token==null||"".equals(access_token))
		{
			access_token = getAccessToken(appId, appSecret);
		}
		...
		try {
			...
			filterObj.put("is_to_all", is_to_all);
			j.put("filter", filterObj);
		} catch (JSONException e1) {
			e1.printStackTrace();
		}
	 ...
	 * @return 示例 ：{ "errcode":0, "errmsg":"send job submission success", "msg_id":34182 }
	 */
	public static JSONObject sendMsgByOpenList(String appId, String appSecret,String msgType, String mediaId, List<String> userIdList,String access_token){
		if(access_token==null||"".equals(access_token))
		{
			access_token = getAccessToken(appId, appSecret);
		}
	 ...
	 * @return
	 */
	public static JSONObject getMediaIdVideo(String appId, String appSecret, String mediaId, String title, String description,String access_token){
		if(access_token==null||"".equals(access_token))
		{
			access_token = getAccessToken(appId, appSecret);
		}
...
//					j.put("mpnews", new JSONObject().put("media_id", getMpnewsId(appId, appSecret).getString("media_id")));
	 ...
	 * @return
	 */
	public static JSONObject sendServiceMsg(String appId, String appSecret,String openId, String msgType, String mediaId,String access_token){
		if(access_token==null||"".equals(access_token))
		{
			access_token = getAccessToken(appId, appSecret);
		}
	 ...
	 */
	public static JSONObject getKFList(String appId, String appSecret,String access_token){
		if(access_token==null||"".equals(access_token))
		{
			access_token = getAccessToken(appId, appSecret);
		}
	 ...
	 */
	public static JSONObject getOnLineKFList(String appId, String appSecret,String access_token){
		if(access_token==null||"".equals(access_token))
		{
			access_token = getAccessToken(appId, appSecret);
		}
	 ...
	 */
	public static JSONObject getRecord(String appId, String appSecret,Long starttime,Long endtime,String openid,int pagesize,int pageindex,String access_token){
		if(access_token==null||"".equals(access_token))
		{
			access_token = getAccessToken(appId, appSecret);
		}
...
//	}
	 ...
	 * @return
	 * @creater: 李梦婷
	 * @creationDate:2016年11月21日 下午2:43:38
	 */
	public static JSONObject getOauthUserInfo(String accessToken, String openId){
		String url = "https://api.weixin.qq.com/sns/userinfo?access_token="+accessToken+"&openid="+openId+"&lang=zh-CN";
		
		String rtn = weixinRequest(url,null,"GET");
		System.out.println("WeixinManager.getOauthUserInfo()"+rtn);
		JSONObject json;
		try {
			json = new JSONObject(rtn);
		} catch (JSONException e) {
